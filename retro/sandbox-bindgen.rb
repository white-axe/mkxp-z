...
HEADER_START = <<~HEREDOC
  ...
  */
  ...
  #if WABT_BIG_ENDIAN
  #define DESERIALIZE_PTR(value) __builtin_bswap#{MEMORY64 ? '64' : '32'}(value)
  #else
  #define DESERIALIZE_PTR(value) (value)
  #endif
...
File.open('mkxp-sandbox-bindgen.h', 'w') do |file|
  ...
  for global_name in globals
    file.write("        inline VALUE #{global_name}() { return DESERIALIZE_PTR(*(VALUE *)(this->instance->w2c_memory.data + this->instance->w2c_#{global_name})); }\n")
  end
