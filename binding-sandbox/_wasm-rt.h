...
__attribute__((__visibility__("default"))) bool _wasm_rt_is_initialized(void);

__attribute__((__visibility__("default"))) void _wasm_rt_trap(wasm_rt_trap_t error);

__attribute__((__visibility__("default"))) void _wasm_rt_allocate_memory(wasm_rt_memory_t *memory, uint32_t initial_pages, uint32_t max_pages, bool is64);

__attribute__((__visibility__("default"))) uint32_t _wasm_rt_grow_memory(wasm_rt_memory_t *memory, uint32_t pages);

__attribute__((__visibility__("default"))) void _wasm_rt_free_memory(wasm_rt_memory_t *memory);

__attribute__((__visibility__("default"))) void _wasm_rt_allocate_funcref_table(wasm_rt_funcref_table_t *table, uint32_t elements, uint32_t max_elements);

__attribute__((__visibility__("default"))) void _wasm_rt_free_funcref_table(wasm_rt_funcref_table_t *table);

__attribute__((__visibility__("default"))) uint32_t _wasm_rt_push_funcref(wasm_rt_funcref_table_t *table, wasm_rt_funcref_t funcref);
